...
class Unescaper
{
     ...
     *
     * @throws RuntimeError if no suitable encoding function is found (iconv or mbstring)
     */
    private function convertEncoding($value, $to, $from)
    {
        ...
        throw new RuntimeError('No suitable convert encoding function (install the iconv or mbstring extension).');
    }
}
