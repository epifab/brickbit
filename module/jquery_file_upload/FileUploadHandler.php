...
class _OriginalJQueryFileUploadHandler {
  ...
  protected function get_upload_path($file_name = null, $version = null) {
    ...
    if (empty($version)) {
      ...
      $version_dir = Utils::arrayElement($this->options, "image_versions|{$version}|upload_dir");
      if ($version_dir) {
  ...
  protected function get_download_url($file_name, $version = null, $direct = false) {
    ...
    if (empty($version)) {
      ...
      $version_url = Utils::arrayElement($this->options, "image_versions|{$version}|upload_url");
      if ($version_url) {
  ...
  protected function validate($uploaded_file, $file, $error, $index) {
    ...
    $max_width = Utils::arrayElement($this->options, 'max_width');
    $max_height = Utils::arrayElement($this->options, 'max_height');
    $min_width = Utils::arrayElement($this->options, 'min_width');
    $min_height = Utils::arrayElement($this->options, 'min_height');
  ...
  protected function trim_file_name($file_path, $name, $size, $type, $error, $index, $content_range) {
    ...
    if (function_exists('exif_imagetype')) {
      ...
      if (!empty($extensions)) {
        ...
        $ext = strtolower(Utils::arrayElement($parts, $extIndex));
  ...
  protected function gd_destroy_image_object($file_path) {
    $image = Utils::arrayElement($this->image_objects, $file_path);
  ...
  protected function gd_orient_image($file_path, $src_img) {
    ...
    $orientation = intval(Utils::arrayElement($exif, 'Orientation'));
  ...
  protected function imagemagick_create_scaled_image($file_name, $version, $options) {
    list($file_path, $new_file_path) = $this->get_scaled_image_file_paths($file_name, $version);
    $resize = Utils::arrayElement($options, 'max_width')
