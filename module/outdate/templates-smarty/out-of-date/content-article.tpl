<{function name="print_content"}>
	<div class="content content-article">
		<div class="article <{$content->style}>" id="content-<{$content->id}>">
			<{if $content->style == 1}>
		...
		<div class="content-footer">
			<div class="subcontents" id="subcontents-<{$content->id}>">
				<{if count($content->contents)}>
					<{foreach $content->contents as $subcontent}>
						<div class="subcontent<{protected url="content/edit/`$content->url`"}> editable<{/protected}>">
			...
			<{if !$private.login->isAnonymous()}>
				<div class="download_link">
					<a href="content/download/<{$content->download_file_name}>">
						<p class="download"><span class="first">D</span>OWNLOAD</p>
					</a>
				</div>
			<{elseif $level == 1}>
				<div class="download_link">
...
<{/function}>
<{block}>
<{print_content content="content" level=1}>
<{/block}>
