...
!function(e, t) {
  ...
  r(l, [], function() {
    ...
    E = o.isXML = function(e) {
      ...
      if ((e.ownerDocument || e) !== B && A(e), t = t.replace(Ct, "='$1']"), z.matchesSelector && L && (!M || !M.test(t)) && !H.test(t))
        try {
          var n = P.call(e, t);
    ...
    function t(n) {
      ...
      function _(e, t, r) {
        var i, o;
        for (e?(H[V] = t, H[W] = r):(H[U] = t, H[q] = r), i = H[U]; i.parentNode; )
          i = i.parentNode;
      ...
      function E(e) {
        ...
        if (e != I && (t = r()), H[W] == H[q])
          return t;
        if (3 == H[V].nodeType) {
          if (n = H[V].nodeValue, i = n.substring(H[W], H[q]), e != O && (o = H[V], c = H[W], u = H[q] - H[W], 0 === c && u >= o.nodeValue.length - 1 ? o.parentNode.removeChild(o) : o.deleteData(c, u), H.collapse(F)), e == I)
            return;
          return i.length > 0 && t.appendChild(M.createTextNode(i)), t
        }
        for (o = C(H[V], H[W]), a = H[q] - H[W]; o && a > 0; )
      ...
      function k(e, t) {
        var n, i, o, a, s, l;
        for (t != I && (n = r()), o = A(e, t), n && n.appendChild(o), i = j(e), ++i, a = H[q] - i, o = e.nextSibling; o && a > 0; )
      ...
      function B(e, t, r, i) {
        ...
        if (t)
          return D(e, i);
        if (3 == e.nodeType) {
          if (o = e.nodeValue, r ? (l = H[W], a = o.substring(l), s = o.substring(0, l)) : (l = H[q], a = o.substring(0, l), s = o.substring(l)), i != O && (e.nodeValue = s), i == I)
            return;
    ...
    return r.prototype = {get: function(e) {
        ...
        if (r.language && r.languageLoad !== !1) {
          if (n && new RegExp("([, ]|\\b)" + r.language + "([, ]|\\b)").test(n) === !1)
            return;
    ...
    function n(e) {
      this.walk = function(t, n) {
        ...
        function r(r) {
          ...
          function l(n, r) {
            var a, s, l;
            if (r = r || c, l = e.getParent(r.parentNode, e.isBlock) || f, n && "BR" == r.nodeName && v && e.isEmpty(l))
          ...
          if (c = n[(r ? "start" : "end") + "Container"], u = n[(r ? "start" : "end") + "Offset"], v = 1 == c.nodeType && u === c.childNodes.length, m = e.schema.getNonEmptyElements(), g = r, 1 == c.nodeType && u > c.childNodes.length - 1 && (g = !1), 9 === c.nodeType && (c = e.getRoot(), u = 0), c === f) {
            if (g && (p = c.childNodes[u > 0 ? u - 1 : 0], p && (h = p.nodeName.toLowerCase(), m[p.nodeName] || "TABLE" == p.nodeName)))
              return;
      ...
      function P(t) {
        ...
        if (3 == n.nodeType && r >= n.nodeValue.length && (r = q(n), n = n.parentNode, i = !0), 1 == n.nodeType)
          for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, I.getParent(n, I.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next())
            if (3 == a.nodeType && !S(a))
              return l = I.create("a", null, $), a.parentNode.insertBefore(l, a), t.setStart(a, 0), F.setRng(t), void I.remove(l)
      }
      ...
      return t.on("init", function() {
        ...
        e.isDefaultPrevented() || t.nodeChanged()
          ...
          if (e = e || {}, e.content = i(), d || t.removed)
            return null;
          if (t.fire("BeforeAddUndo", {level: e, originalEvent: n}).isDefaultPrevented())
            return null;
          if (a = l[s], a && a.content == e.content)
            return null;
    ...
    return function(a) {
      ...
      function d() {
        ...
        a.on("keydown", function(e) {
          var t = e.keyCode, r, i;
          if (!c(e) && (t == W || t == z)) {
            if (r = a.selection.isCollapsed(), i = a.getBody(), r && !V.isEmpty(i))
              return;
      ...
      function m() {
        a.on("keydown", function(e) {
          if (!c(e) && e.keyCode === z && U.isCollapsed() && 0 === U.getRng(!0).startOffset) {
            ...
            if ("HR" == t.nodeName)
              return V.remove(t), void e.preventDefault();
    ...
    var c = n.DOM, u = o.explode, d = o.each, f = o.extend, p = 0, m, h = {majorVersion: "4", minorVersion: "0.18", releaseDate: "2014-02-27", editors: [], i18n: s, activeEditor: null, setup: function() {
        ...
        function o() {
          ...
          if (c.unbind(window, "ready", o), r(t, "onpageload"), t.types)
            return void d(t.types, function(r) {
          ...
          if (t.selector)
            return void d(c.select(t.selector), function(r) {
              var i = new e(n(r), t, a);
              s.push(i), i.render(1)
            });
          switch (t.mode) {
        ...
        var t = this, n, r = t.editors, i, o;
        {
          if (e) {
            if ("string" == typeof e)
              return e = e.selector || e, void d(c.select(e), function(e) {
                t.remove(r[e.id])
              });
            if (i = e, !r[i.id])
              return null;
    ...
    return e.extend({recalc: function(e) {
        ...
        for (r = e.items().filter(":visible"), i = e.layoutRect(), o = e._paddingBox, a = e.settings, f = e.isRtl()?a.direction || "row-reversed":a.direction, s = a.align, l = e.isRtl()?a.pack || "end":a.pack, c = a.spacing || 0, ("row-reversed" == f || "column-reverse" == f) && (r = r.set(r.toArray().reverse()), f = f.split("-")[0]), "column" == f?(S = "y", N = "h", E = "minH", k = "maxH", R = "innerH", T = "top", A = "bottom", B = "deltaH", D = "contentH", I = "left", M = "w", L = "x", H = "innerW", P = "minW", O = "maxW", F = "right", z = "deltaW", W = "contentW"):(S = "x", N = "w", E = "minW", k = "maxW", R = "innerW", T = "left", A = "right", B = "deltaW", D = "contentW", I = "top", M = "h", L = "y", H = "innerH", P = "minH", O = "maxH", F = "bottom", z = "deltaH", W = "contentH"), d = i[R] - o[T] - o[T], _ = u = 0, t = 0, n = r.length; n > t; t++)
          p = r[t], m = p.layoutRect(), h = p.settings, g = h.flex, d -= n - 1 > t ? c : 0, g > 0 && (u += g, m[k] && v.push(p), m.flex = g), d -= m[E], y = o[I] + m[P] + o[F], y > _ && (_ = y);
        if (x = {}, x[E] = 0 > d ? i[E] - d + i[B] : i[R] - d + i[B], x[P] = _ + i[z], x[D] = i[R] - d, x[W] = _, x.minW = U(x.minW, i.maxW), x.minH = U(x.minH, i.maxH), x.minW = V(x.minW, i.startMinWidth), x.minH = V(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
          ...
          for (C = d / u, w = o[T], x = {}, 0 === u && ("end" == l?w = d + o[T]:"center" == l?(w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T], 0 > w && (w = o[T])):"justify" == l && (w = o[T], c = Math.floor(d / (r.length - 1)))), x[L] = o[I], t = 0, n = r.length; n > t; t++)
            p = r[t], m = p.layoutRect(), y = m.maxFlexSize || m[E], "center" === s ? x[L] = Math.round(i[H] / 2 - m[M] / 2) : "stretch" === s ? (x[M] = V(m[P] || 0, i[H] - o[I] - o[F]), x[L] = o[I]) : "end" === s && (x[L] = i[H] - m[M] - o.top), m.flex > 0 && (y += m.flex * C), x[N] = y, x[S] = w, p.layoutRect(x), p.recalc && p.recalc(), w += y + c
        ...
        if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
          ...
          for (m = g.top, f = 0; n > f; f++) {
            for (p = g.left, s = E[f] + D, d = 0; r > d && (u = i[f * r + d], u); d++)
              h = u.settings, c = u.layoutRect(), a = Math.max(N[d], c.startMinWidth), T = R = 0, c.x = p, c.y = m, v = h.alignH || (C ? C[d] || C[0] : null), "center" == v ? c.x = p + a / 2 - c.w / 2 : "right" == v ? c.x = p + a - c.w : "stretch" == v && (c.w = a), v = h.alignV || (x ? x[d] || x[0] : null), "center" == v ? c.y = m + s / 2 - c.h / 2 : "bottom" == v ? c.y = m + s - c.h : "stretch" == v && (c.h = s), u.layoutRect(c), p += a + y, u.recalc && u.recalc();
            m += s + b
          }
