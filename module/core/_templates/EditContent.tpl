...
<table class="xmca_dataedit">
	...
	<tr>
		...
		<td class="input">
			<input type="textbox" class="content_tags" name="recordset[tags]" size="50" value="<{$recordset->tags|xmca_tags}>"/>
		</td>
	</tr>
	<tr>
		...
		<td class="input">
			<div class="xmca_languages_input">
				...
				<a href="javascript:EditPageLang('<{$lang}>')" id="lang_control_<{$lang}>" class="lang_control"><img src="img/layout/lang/40/<{$lang}>.jpg"/></a>
				<{/foreach}>
			</div>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<div style="float: left">
				<input type="radio" name="recordset[layout_type]" value="1"<{if $recordset->layout_type == 1 || $recordset->layout_type == ''}> checked="checked"<{/if}>/>
				<img src="img/layout/content_layout_1.jpg" alt="Layout 1"/>
			</div>
			<div style="float: left">
				<input type="radio" name="recordset[layout_type]" value="2"<{if $recordset->layout_type == 2}> checked="checked"<{/if}>/>
				<img src="img/layout/content_layout_2.jpg" alt="Layout 2"/>
			</div>
			<div style="float: left">
				<input type="radio" name="recordset[layout_type]" value="3"<{if $recordset->layout_type == 3}> checked="checked"<{/if}>/>
				<img src="img/layout/content_layout_3.jpg" alt="Layout 3"/>
			</div>
			<div style="clear: both"></div>
			
			<{if array_key_exists("layout_type", $errors)}>
			<p class="alert"><{$errors.layout_type}></p>
			<{/if}>
		</td>
	</tr>
	*}>
