...
/**
 * Class for managing table: xmca_page_tag
 * XMCA PHP Generator 0.1 - Auto generated code
 * @author episoft
 */
class XmcaPageTag extends RecordsetBuilder implements RecordsetBuilderInterface {
	public function getTableName() {
		return "xmca_page_tag";
	}
	...
	protected function loadKeys() {
		return array (
			"primary_key" => array("page_id", "tag_id")			
		);
	}
