...
class NodeFileController extends Component {
  public static function accessUpload($pageArgs, RecordsetInterface $user) {
  ...
  public static function getDirId() {
    $dirId = Main::getCache('core-nodefile-dir-id', null);
    if (!$dirId) {
      ...
      $dirId = $rs->id;
      Main::setCache('core-nodefile-dir-id', $rs->id);
    }
    return $dirId;
  }
