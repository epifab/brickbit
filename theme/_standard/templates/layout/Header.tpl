...
<!--	<div class="search">
	...
	<div id="header_sidebar_login">
		<{if $private.login->isAnonymous()}>
			<a href="javascript:<{ciderbit_control_action component="Login" okButtonLabel="Login" width=300 showResponse=false}>"><img src="<{$private.siteAddr}>img/lock.jpg" alt="Login"/></a></li>
		<{else}>
			<a href="javascript:<{ciderbit_control_action component="Login" args=['logout'=>1] showResponse=false}>"><img src="<{$private.siteAddr}>img/unlock.jpg" alt="Logout"/></a></li>
		<{/if}>
	</div>
