			...
			{if $content->layout_type == 1}
				...
				{if $content->image_id}
					<div class="content_full_image upper">
						<img src="{$content->image->path_file1}" alt="{$content->getEdit("title")}" width="{$content->image->width1}" height="{$content->image->height1}"/>
					</div>
				{/if}
			...
			{elseif $content->layout_type == 2}
				...
				{if $content->image_id}
					<div class="content_full_image left">
						<img src="{$content->image->path_file2}" alt="{$content->getEdit("title")}" width="{$content->image->width2}" height="{$content->image->height2}"/>
					</div>
				{/if}
				<div class="content_full_body">
					{$content->body}
		...
		{if $content->download_file_id}
			{if !$private.login->isAnonymous()}
				<div class="download_link">
					<a href="Content.html?url={$content->url}&amp;download=1">
